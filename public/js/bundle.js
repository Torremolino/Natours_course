...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9ycmVtb2xpbm8iLCJhIjoiY2tpZWd4ejc4MTNpajJxcGU4Nnc1ZnA4ciJ9.okNnAKexKAQUtGhG9Tf7hA';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Añadir marca

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //Añadir popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds para incluir la localizacion actual
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Legeado correctamente');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " guardado correctamente"));
            } //console.log(res);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51I3OTTKeInpdE4LNFYYaHNMTeC9dfvtFmAGtHX8gZ7HXBQNE3YuAkwADQ6Yqx5QGLzykYDetE2qSAcBYXCAAuuzS00Euu5gisK');
            _context.prev = 1;
            _context.next = 4;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = 'Guardar password';
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'procesando...'; //const { tourId } = e.target.dataset;

  var tourId = e.target.dataset.tourId; //e.target is the current
  //console.log(tourId);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "28611" + '/');
